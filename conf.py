...
extensions = ['sphinx_togglebutton', 'sphinx_copybutton', 'myst_nb', 'jupyter_book', 'sphinx_thebe', 'sphinx_comments', 'sphinx_external_toc', 'sphinx.ext.intersphinx', 'sphinx_design', 'sphinx_book_theme', 'sphinx_click.ext', 'sphinx_inline_tabs', 'sphinxext.rediraffe', 'sphinx_proof', 'sphinx_examples', 'sphinxcontrib.bibtex', 'sphinx_jupyterbook_latex']
